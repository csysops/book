...
- computer architecture:
  - `architecture`: what the programmer sees (x86-64, arm)
  - `micro-architecture`: how the cpu implements that architecture internally
- as a server, if you do not binding, the os don’t know where to direct the message, the os peak port, but don’t know which socket belong to for directing, socket is a abstraction, os treat as a file to do communicating by writing or reading
